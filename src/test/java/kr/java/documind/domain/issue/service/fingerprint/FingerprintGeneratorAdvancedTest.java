...
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DB_DUPLICATE_KEY;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DB_QUERY_TIMEOUT;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DYNAMIC_FILE_PATH_UNIX;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DYNAMIC_FILE_PATH_WINDOWS;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DYNAMIC_IP_ADDRESS;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DYNAMIC_ITEM_IDS;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DYNAMIC_TIMESTAMP;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.DYNAMIC_UUID;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.GAME_INSUFFICIENT_CURRENCY;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.GAME_INVALID_STATE;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.GAME_INVENTORY_FULL;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.GAME_MATCHMAKING_TIMEOUT;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.GAME_PLAYER_BANNED;
...
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.ILLEGAL_STATE;
...
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.NETWORK_NETTY_TIMEOUT;
...
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.STACK_OVERFLOW;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.UNITY_MISSING_COMPONENT;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.UNITY_NULL_REFERENCE;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.UNITY_UNASSIGNED_REFERENCE;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.UNREAL_ASSERTION_FAILED;
import static kr.java.documind.domain.issue.service.fingerprint.GameErrorPatterns.UNREAL_BLUEPRINT_ERROR;

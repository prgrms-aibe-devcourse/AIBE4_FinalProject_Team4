...
public class SidebarMenuResolver {
    ...
    private String resolveHref(ServiceMenu menu, String activeProject) {
        return switch (menu) {
            ...
            case CHATBOT -> activeProject != null
                ? "/projects/" + activeProject + "/chatbot"
                : "#";

            case LOGS -> activeProject != null
                ? "/projects/" + activeProject + "/logs"
                : "#";

            case ISSUES -> activeProject != null
                ? "/projects/" + activeProject + "/issues"
                : "#";
            ...
            case ALERTS -> activeProject != null
                ? "/projects/" + activeProject + "/alerts"
                : "#";

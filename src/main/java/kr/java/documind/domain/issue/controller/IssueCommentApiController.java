...
@RestController
@RequestMapping("/api/projects/{publicId}/issues/{issueId}/comments")
...
public class IssueCommentApiController {
    ...
    public ResponseEntity<ApiResponse<CommentResponse>> createComment(
        ...
        CommentResponse response =
                issueCommentService.createComment(
                        issueId, ctx.projectId(), authMember.getMemberId(), request);
    ...
    public ApiResponse<List<CommentResponse>> getComments(
        ...
        Page<CommentResponse> comments =
                issueCommentService.getComments(issueId, ctx.projectId(), pageable);
    ...
    public ResponseEntity<ApiResponse<CommentResponse>> updateComment(
        ...
        CommentResponse response =
                issueCommentService.updateComment(
                        commentId, issueId, ctx.projectId(), authMember.getMemberId(), request);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteComment(
        ...
        issueCommentService.deleteComment(
                commentId, issueId, ctx.projectId(), authMember.getMemberId());

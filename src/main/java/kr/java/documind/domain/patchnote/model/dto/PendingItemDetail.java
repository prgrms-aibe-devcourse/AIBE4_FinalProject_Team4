...
public record PendingItemDetail(
        ...
        @Schema(description = "LLM이 생성한 요약", example = "몬스터 체력·공격력 수치가 조정되었습니다.") String summary,
        ...
        @Schema(description = "원본 소스 생성 일시 (ISO 8601)", example = "2025-06-01T09:00:00Z")
                OffsetDateTime sourceCreatedAt,
        @JsonInclude(JsonInclude.Include.ALWAYS)
                @Schema(
                        description = "원본 소스 링크. sourceDeleted=true이면 null (원본이 삭제되어 이동 불가)",

 ...
 *
 * @param cleanedContent {@link kr.java.documind.domain.patchnote.service.PatchNoteRenderer}가
 *                       렌더링한 마크다운 텍스트. {@code {{source:REF}}} 인라인 태그가 포함되어 있으며,
 *                       프론트엔드에서 링크로 치환하거나 제거하여 표시한다.
